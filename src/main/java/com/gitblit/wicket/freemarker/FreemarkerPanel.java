...
public class FreemarkerPanel extends Panel
     ...
     * @param values   values map that can be substituted by Freemarker.
     */
     ...
     *
     * @param id       Component id
     * @param template The Freemarker template as a string resource
     * @param model    Model with variables that can be substituted by Freemarker.
     */
    ...
    /**
     * @see org.apache.wicket.markup.html.panel.Panel#onComponentTagBody(org.apache.wicket.markup.MarkupStream, org.apache.wicket.markup.ComponentTag)
     */
    @Override
     ...
     *
     * @param template used to read the template
