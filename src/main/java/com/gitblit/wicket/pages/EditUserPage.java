...
public class EditUserPage extends RootSubPage {
    ...
    protected void setupPage(final UserModel userModel) {
        ...
        final Palette<String> teams = new Palette<>("teams",
                new ListModel<>(new ArrayList<>(userTeams)),
                new CollectionModel<>(app().users().getAllTeamNames()),
                new StringChoiceRenderer(), 10, false);
        teams.add(new DefaultTheme());
