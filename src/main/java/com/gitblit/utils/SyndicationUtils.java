...
public class SyndicationUtils {
     ...
     *
     * @param url             the url of the Gitblit server
     * @param repository      the repository name
     * @param branch          the branch name (optional)
     * @param numberOfEntries the number of entries to retrieve. if <= 0 the server default
     *                        is used.
     * @param page            0-indexed. used to paginate the results.
     * @param username
     * @param password
     ...
     * @throws {@link IOException}
     */
    public static List<FeedEntryModel> readTags(String url,
                                                String repository,
                                                int numberOfEntries,
                                                int page,
                                                String username,
     ...
     * @param repository      the repository name
     * @param branch          the branch name (optional)
     * @param objectType      the object type to return (optional, COMMIT assummed)
     * @param numberOfEntries the number of entries to retrieve. if <= 0 the server default
     *                        is used.
     * @param page            0-indexed. used to paginate the results.
     * @param username
     ...
     * @param url             the url of the Gitblit server
     * @param repository      the repository name
     * @param fragment        the search fragment
     * @param searchType      the search type (optional, defaults to COMMIT)
     * @param numberOfEntries the number of entries to retrieve. if <= 0 the server default
     *                        is used.
     * @param page            0-indexed. used to paginate the results.
     * @param username
     ...
     *
     * @param url        the url of the Gitblit server
     * @param parameters the list of RSS parameters
     * @param repository the repository name
     * @param username
     * @param password
     * @return a list of SyndicationModel entries
